...
public class TextFile implements IOType {
	...
	public boolean read(Vector<String> arg0) {  // stores evry line in txt to arg0
		...
		try {
			...
			e.printStackTrace();
			succesfull = false;
		} finally {  // der Programmcode im finally-Block immer ausgeführt wird, egal, ob es einen Fehler gab oder ob es keinen Fehler gab und die Routine glatt durchlief.

			 while(!close()) {} // versucht solange zu schließen bis er erfolgreich ist.   #Hackerstyle ;)
		}
		return succesfull;
	}
