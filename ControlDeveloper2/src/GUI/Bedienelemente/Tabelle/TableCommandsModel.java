...
public class TableCommandsModel extends AbstractTableModel {
	...
	/**
	 * Methode um einen Command zu erstellen und diesen der Tabelle hinzuf�gen
	 * 
	 * @param strCommand
	 */
	...
	/**
	 * Methode um einen Command aus der Tabelle zu l�schen
	 * 
	 * @param row
	 */
...
//		listCommands.remove(row);
	...
	/**
	 * Methode um einen ausgew�hlten Command um eine Zeile nach oben zu verschieben
	 * 
	 * @param row
	 */
	...
	/**
	 * Methode um einen Ausgew�hlten Command um eine Zeile nach unten zu verschieben
	 * 
	 * @param row
	 */
	...
	/**
	 * Methode die dei Spalten�berschirften festlegt
	 */
	@Override
